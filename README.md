...
## サービス概要
- 「思いの竹〜焚き火に灯すやすらぎ〜」は、焚き火に「思いの竹」をくべて燃やすことで癒しをとどけるアプリです。
- タップやクリックで「思いの竹」を焚き火にくべることができます。  
- ゆらゆら揺れる炎と竹のパチパチと爆ぜる音が、リラックスできるひと時をとどけます。
...
### 利用の流れ
1. **思いを託す**  
   心に抱えた悩みやモヤモヤを入力し、竹にこめる  
2. **焚き火にくべる**  
   炎のゆらぎと心地よい音に包まれながら、竹を燃やす体験を楽しむ  
3. **癒しを感じる**  
   竹にこめた思いを燃やすことで気持ちを整理し、心が軽くなる
...
- **竹をくべる操作**  
  「思いの竹」を焚き火にくべるアクション。  
- **炎のアニメーション**  
  炎のゆらぎを視覚的に表現し、没入感を演出。  
- **音の演出**  
  焚き火の音を再生し、聴覚的な癒しを提供。  
- **竹をくべると炎が一時的に揺らぐ機能**  
  アクションに応じて炎が反応し、体験に動的なリアリティを加える。  
...
- **炎を育てる機能**  
  アプリ起動時は種火から始まり、竹をくべることで炎が育つ。時間経過で炎が小さくなることで、より焚き火らしいリアリティと楽しさを演出する。  
- **バックグラウンド再生機能**  
